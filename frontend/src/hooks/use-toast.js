...
// --- Helpers extracted from reducer to keep each case small and testable ---
...
function useToast() {
  ...
  React.useEffect(() => {
    // `listeners` is a stable module-level array and `setState` is React-stable,
    // so this effect only needs to subscribe on mount and unsubscribe on unmount.
